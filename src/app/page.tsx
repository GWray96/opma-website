      ...
      <div className="relative isolate">
        ...
        <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8 lg:py-40">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              We handle your marketing, AI systems, and workflow automations so you can focus on what matters most - growing your business.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              From marketing strategy to AI integration and workflow automation, we've got you covered.
            </p>
          </div>
