...
const services = [
  {
    ...
    description: 'Comprehensive digital marketing strategies to increase your online presence and drive qualified leads to your business.',
    icon: (
  ...
  },
  {
    ...
    description: 'Custom AI solutions to automate repetitive tasks, analyze data, and provide actionable insights for your business.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'High-quality, engaging content that resonates with your target audience and drives engagement.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Data-driven insights and comprehensive reporting to help you make informed business decisions.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
