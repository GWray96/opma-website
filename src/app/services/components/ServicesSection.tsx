...
const services = [
  ...
  },
  {
    ...
    description: 'Boost your online presence with data-driven marketing strategies tailored to your business goals.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Leverage the power of artificial intelligence to make smarter business decisions and automate complex tasks.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
