...
export const PricingPreview = () => {
  return (
    <section className="relative py-24 bg-gradient-to-b from-white to-gray-50 overflow-visible z-10">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto relative z-10">
