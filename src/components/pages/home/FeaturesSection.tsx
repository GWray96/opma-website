...
const features = [
  {
    ...
    description: 'Customized marketing strategies that align with your business goals and target audience.',
    icon: (
  ...
  {
    name: 'AI Integration',
    description: 'Leverage cutting-edge AI technology to automate processes and gain valuable insights.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
